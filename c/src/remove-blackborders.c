...
extern int remove_blackborders(double**,int*,int*,double*,double*,double*,int,int,int,int,int,double,char,char); // see source file 'remove-blackborders_kernel.c'
...
static void display_usage()
{
  ...
  printf(" -r r        : (default 0.025) sharpness parameter for the Tukey apodization profiles\n"); 
  printf(" -v          : enable verbose mode\n");
  printf(" -e          : replace the Tukey apodization profiles by the erfc apodization profiles\n");
  printf("               with smoothness parameter sigma = r / 0.025.\n");
...
{
  char *datatype=NULL,*fname_in=NULL,*fname_T=NULL,*fname_out=NULL,*m_value=NULL,*n_value=NULL,*zx_value=NULL,*zy_value=NULL,*r_value=NULL,vflag=0,eflag=0;
  double *dx=NULL,*dy=NULL,zx,zy,zx_tmp,zy_tmp,r,*u=NULL,*ucrop=NULL;
  ...
  /* CORE OF THE ROUTINE */
  /***********************/
  if(EXIT_FAILURE == remove_blackborders(&ucrop,&Nxcrop,&Nycrop,u,dx,dy,Nx,Ny,nx,ny,ntranslations,r,vflag,eflag)) {
